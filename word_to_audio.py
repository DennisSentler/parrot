...
def google_cloud_tts(text, lang_list, output_path):
    ...
    for voice in voice_list.voices:
        ...
        for i in range(10):
            ...
            file_name = '{4}_gcp_{0}_{5}_{1}r{2}v{3}p.wav'.format(voice.name, random_rate, random_volume, random_pitch, text, gender_char)
            with open(output_path + '/' + file_name, 'wb') as f:
...
def main():
    ...
    parser.add_argument('--lang', nargs='*', help='To generate for languages', default=['en-US'])
